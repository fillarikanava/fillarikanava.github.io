(function() {
  var Service, ServiceList, ServiceListView, root_list, show_categories, srv_list, srv_list_view, _ref, _ref1, _ref2,
  ...
  Service = (function(_super) {
    ...
    Service.prototype.get_children = function() {
      var child, child_list, id, _i, _len, _ref1;
      child_list = [];
      _ref1 = this.get('child_ids');
  ...
  ServiceList = (function(_super) {
    ...
    function ServiceList() {
      _ref1 = ServiceList.__super__.constructor.apply(this, arguments);
      return _ref1;
    }
    ...
    ServiceList.prototype.find_parents = function() {
      ...
      return this.forEach(function(srv) {
        var child, child_id, _i, _len, _ref2, _results;
        if (!srv.get('child_ids')) {
          return;
        }
        _ref2 = srv.get('child_ids');
        _results = [];
  ...
  ServiceListView = (function(_super) {
    ...
    function ServiceListView() {
      _ref2 = ServiceListView.__super__.constructor.apply(this, arguments);
      return _ref2;
    }
